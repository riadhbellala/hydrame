  ...
  const fetchProject = async () => {
    try {
      ...
      setFormData({
        ...
        desc: data.description || '',      // ✅ maps DB "description" → form "desc"
        tags: Array.isArray(data.tags) ? data.tags.join(', ') : '',
        published: !!data.published,
        metrics: Array.isArray(data.stats) && data.stats.length > 0
          ? data.stats
          : [{ label: '', value: '' }]     // ✅ maps DB "stats" → form "metrics"
      });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const payload = {
        ...
        description: formData.desc,        // ✅ form "desc" → DB "description"
        ...
        stats: cleanedMetrics,             // ✅ form "metrics" → DB "stats"
